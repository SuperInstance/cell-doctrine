...
The cell-doctrine: every cell is irreducible, every observation is a witness, every witness is a prediction.

## What it does

This package defines the **cell doctrine** substrate primitive.
...
```bash
npm install @superinstance/cell-doctrine
```

## Usage

```js
const { /* exports */ } = require('@superinstance/cell-doctrine');
